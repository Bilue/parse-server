...
var ParseServer = function () {
  function ParseServer(_ref) {
    var _ref$appId = _ref.appId,
        ...
        _ref$analyticsAdapter = _ref.analyticsAdapter,
        analyticsAdapter = _ref$analyticsAdapter === undefined ? undefined : _ref$analyticsAdapter,
        filesAdapter = _ref.filesAdapter,
        push = _ref.push,
        loggerAdapter = _ref.loggerAdapter,
        jsonLogs = _ref.jsonLogs,
        logsFolder = _ref.logsFolder,
        databaseURI = _ref.databaseURI,
        ...
        _ref$fileKey = _ref.fileKey,
        fileKey = _ref$fileKey === undefined ? undefined : _ref$fileKey,
        ...
        enableAnonymousUsers = _ref$enableAnonymousU === undefined ? true : _ref$enableAnonymousU,
        _ref$allowClientClass = _ref.allowClientClassCreation,
        allowClientClassCreation = _ref$allowClientClass === undefined ? true : _ref$allowClientClass,
        ...
        maxUploadSize = _ref$maxUploadSize === undefined ? '300mb' : _ref$maxUploadSize,
        _ref$verifyUserEmails = _ref.verifyUserEmails,
        verifyUserEmails = _ref$verifyUserEmails === undefined ? false : _ref$verifyUserEmails,
        _ref$preventLoginWith = _ref.preventLoginWithUnverifiedEmail,
        preventLoginWithUnverifiedEmail = _ref$preventLoginWith === undefined ? false : _ref$preventLoginWith,
      ...
      passwordResetSuccess: undefined
        ...
        sessionLength = _ref$sessionLength === undefined ? 31536000 : _ref$sessionLength,
        ...
        revokeSessionOnPasswordReset = _ref$revokeSessionOnP === undefined ? true : _ref$revokeSessionOnP,
        _ref$schemaCacheTTL = _ref.schemaCacheTTL,
        schemaCacheTTL = _ref$schemaCacheTTL === undefined ? 5 : _ref$schemaCacheTTL,
  ...
  _createClass(ParseServer, [{
    ...
    value: function app(_ref2) {
      var _ref2$maxUploadSize = _ref2.maxUploadSize,
          maxUploadSize = _ref2$maxUploadSize === undefined ? '300mb' : _ref2$maxUploadSize,
          appId = _ref2.appId;
